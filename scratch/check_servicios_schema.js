...
const options = {
  ...
  path: `/rest/v1/catalogo_servicios?select=*&limit=1`,
  method: 'GET',
  headers: {
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    try {
      console.log('Columns in catalogo_servicios:', Object.keys(JSON.parse(body)[0] || {}));
      console.log('Sample row:', JSON.parse(body)[0]);
    } catch(e) {
